...
export class Member extends React.Component {
    ...
    render() {
      ...
      >
        ...
        <MuteIcon className={(this.props.muted ? 'muted' : '')}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-volume-mute-fill" viewBox="0 0 16 16">
